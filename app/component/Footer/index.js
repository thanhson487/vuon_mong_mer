      ...
      >
        <div className=" shadow-sm rounded-2xl p-6 md:flex w-full md:w-3/4">
          ...
          <Card className=" w-full md:w-1/2 p-4 shadow-md">
            ...
            <h2 className="text-xl font-semibold mt-3">Vườn Mộng Mer</h2>
            ...
            <div className="flex w-full flex-col  text-green-600 text-base font-semibold">
              ...
              <div className="flex items-center">
                ...
                <img
                  ...
                  className="w-[50px]"
                />
                Facebook: Vườn Mộng Mer
              </div>
              <div className="flex items-center"><img src = "https://img.icons8.com/?size=100&id=-x2V8Q63DerT&format=png&color=000000" className="w-[50px]"/>Tiktok: vumongmer</div>
            </div>
          </Card>
        ...
        <div className="text-center text-[#00a76f] mt-2">
          Copyright © 2021 Vườn mộng mer. All rights reserved
        </div>
      </div>
    </motion.div>
  );
